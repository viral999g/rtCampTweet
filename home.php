					...
					<script id="tweet-template" type="text/x-handlebars-template">
						...
						<div class="radius panel jumbotron" style="margin-top: 8px;background-color: #D1F2EB;">
							<div class="tweet bubble-left" id="{{id_str}}">
								...
								<label class="text-center" style="font-size: 15px;margin-left: 15px" id="">{{user.name}}<span><a style="margin-left: 5px" href="https://www.twitter.com/{{user.screen_name}}" target="_blank">@{{user.screen_name}}</a></span>&nbsp&nbsp<span class="tweet-timestamp" id="">{{getDateTime created_at}}</span></label>

				...
				<div class="large-12 columns" id="tweets">
					<script id="tweet-template" type="text/x-handlebars-template">
						...
						<div class="radius panel jumbotron" style="margin-top: 8px;background-color: #D1F2EB;">
							...
							<div class="row">
								<img class="img-circle col-sm-1" src="{{user.profile_image_url}}" alt="profile image">
								<label class="text-center col-sm-4" style="font-size: 15px;margin-left: 15px" id="">{{user.name}}<span><a style="margin-left: 5px" href="http://www.twitter.com/{{user.screen_name}}" target="_blank">@{{user.screen_name}}</a></span>&nbsp&nbsp</label>
								<label class="tweet-timestamp col-sm-2" id="">{{getDateTime created_at}}</label>
								</div>
